...
for src, (dst, override) in configs.items():
    ...
    if src == 'market-events.html':
        ...
        text = text.replace('<div class="subtitle">시장 주요 이벤트 레이더</div>', '<div class="subtitle">한국·미국 주요 경제 일정을 한눈에</div>')
